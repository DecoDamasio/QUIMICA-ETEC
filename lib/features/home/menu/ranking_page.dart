...
class _RankingScreenState extends State<RankingAlunosScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Painel Acadêmico', style: TextStyle(color: Colors.white, fontSize: 18)),
        backgroundColor: const Color(0xFF26324D),
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Colors.white),
          onPressed: () => Navigator.of(context).pop(), // Botão de retorno
        ),
      ),
      body: LayoutBuilder(
                  ...
                  Padding(
                    ...
                    child: Flex(
                      ...
                      children: [
                        ...
                        if (isMobile) const SizedBox(height: 12), // Espaçamento no celular
                        Row(
                          ...
                          children: [
                            OutlinedButton(
                              ...
                              child: const Text('Anterior', style: TextStyle(color: Colors.black38)),
                            ),
                            const SizedBox(width: 8),
                            OutlinedButton(
                              onPressed: () {},
                              ...
                              child: const Row(
                                children: [
                                  Text('Próximo', style: TextStyle(color: Colors.black87)),
          ...
          return DataRow(cells: [
            DataCell(
              Column(
                ...
                children: [
                  Text(aluno.nome, style: const TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF262626))),
                  Text('ID: #${aluno.id}', style: const TextStyle(color: Colors.grey, fontSize: 11)),
                ],
              ),
            ),
            ...
            DataCell(
              Text(
                '${aluno.media}',
                style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF262626), fontSize: 15),
              ),
            ),
            DataCell(
              AcoesBotoes(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(aluno.nome, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF262626))),
                      Text('ID: #${aluno.id}', style: const TextStyle(color: Colors.grey, fontSize: 12)),
                    ],
                  ),
                  AcoesBotoes(
                    onVisualizar: () => print('Visualizar ${aluno.nome}'),
              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      const Text('MÉDIA', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey)),
                      const SizedBox(height: 4),
                      Text(
                        '${aluno.media}',
                        style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF26324D)),
                      ),
                    ],
                  ),
                ],
